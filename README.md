...
The Support group can be reached out to at [Son Goku Support](https://t.me/DraGOn_Ball_Chat), where you can ask for help about [SonGokuRobot](https://t.me/SonGokuRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [Son Goku Updates](https:/t.me/SonGokuUpdates) 
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/RockingGokuAMV/Son-Goku.git)
...
Should any be missing kindly let us know at [Son Goku Support](https://t.me/Dragon_Ball_Chat) or simply submit a pull request on the readme.
